//This program displays a message on the LCD using 8-bitmode and polling of the status register
...
GPIOB->BSRR = 0x00C00000; /*turn off EN and et pin output mode */ 
